...
describe('AddTodoComponent', () => {
  ...
  describe('The owner field', () => {
    ...
    it('should be fine with "Ryan Sajulga"', () => {
      ownerControl.setValue('Ryan Sajulga');
  ...
  describe('The status field', () => {
    ...
    beforeEach(() => {
      statusControl = addTodoComponent.addTodoForm.controls.body;
    });
    ...
    it('should not allow "maybe"', () => {
      statusControl.setValue('maybe');
      expect(statusControl.valid).toBeFalsy();
    });
  });
  ...
  */
  ...
  describe('The body field', () => {
    ...
    beforeEach(() => {
      bodyControl = addTodoComponent.addTodoForm.controls.email;
    });
    ...
    it('should accept legal body', () => {
      bodyControl.setValue('abcdefg');
